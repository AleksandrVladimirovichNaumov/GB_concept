...
class User(AbstractUser):
    ...
    role_id = models.ForeignKey(Role, null=True, db_constraint=False, on_delete=models.CASCADE)


class EmployeeProfile(models.Model):
    """профиль для соискателя"""
    user_id = models.ForeignKey(User, null=False, db_index=True, on_delete=models.CASCADE)
